  ...
  export default {
    ...
    data() {
      return {
        sliders: [
          {
            img: require('../../assets/welcome/pic-green-1.jpg')
          },
          {
            img: require('../../assets/welcome/pic-green-2.jpeg')
          },
          {
            img: require('../../assets/welcome/pic-green-icon-1.jpg')
          },
      ...
      animate(des, direc, speed) {
        ...
        this.temp = window.setInterval(() => {
          if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
            ...
            window.clearInterval(this.temp)
            this.distance = des
            if (des < -2400) this.distance = -800
            if (des > -800) this.distance = -2400
          }
        }, 20)
      },
      jump(index) {
